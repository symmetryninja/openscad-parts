...
//Draw
/*
belt_length(profile = "MXL", belt_width = 10, n = 30);
...
module timing_belt_centered(profile = "T2.5", n = 10, belt_width = 5, tooth_pitch = 2.5, backing_thickness = 0.6) {
  translate([-(n * tooth_pitch)/2, 0, -belt_width/2]) {
    _belt_length(profile=profile, n=n, belt_width=belt_width, tooth_pitch=tooth_pitch, backing_thickness=backing_thickness);
  }
